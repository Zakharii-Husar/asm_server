...
directory_traversal_err_msg: .asciz "MODERATE: directory traversal detected in file_open.s from IP: "
...
file_open:
    ...
    mov %rdx, -8(%rbp) # save buffer size
    ...
    cmp -8(%rbp), %rax                   # compare with buffer size
    ...
    mov %r10, %rdi                   # file descriptor
    mov -8(%rbp), %rdx                   # max bytes to read
    syscall
